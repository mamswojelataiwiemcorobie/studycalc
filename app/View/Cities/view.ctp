<div id="miasto" class="view">
	<div class="row">
		<div class="col-xs-12 col-md-3">
			<img class="herb img-responsive center-block" src="/img/miasta/<?php echo $city['City']['photo']?>">
		</div>
...
//Charts
	...
	function drawcharts() {
		...
		var data1 = google.visualization.arrayToDataTable([
			...
			['Przeciętne wynagrodzenie',  <?php if (!empty($city['City']['placa'])) echo $city['City']['placa'];?>,  'color: #FF5F49;']
			<?php endif;?>
