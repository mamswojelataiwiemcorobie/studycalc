...
================================================== -->
		...
		<div class="row">
			...
			<div class="col-md-4 animated fadeInRight notransition">
				...
				<h3><strong>Zostań Studentem Szymański i Wspólnicy sp. j.</strong></h3>
				<p>
				...
				<ul class="unstyled">
					<li><span style="margin-right:5px;"><i class="icon-map-marker"></i></span> Adres: Królewska 65A, 30-081 Kraków</li>
