<div id="form_result" class="row">
	...
	<div class="4u">
		...
		<section id="filtry" class="box filters">
			...
			<form>
				<?php $current_url = "/universities/form_result?country_id=".$result['conditions']['country_id'] ."&city_id=". $result['conditions']['city_id']. "&university_id=".$result['conditions']['university_id'];
